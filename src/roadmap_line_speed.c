...
static void *roadmap_line_speed_map (roadmap_db *root) {
   ...
   if (context == NULL) {
      roadmap_log (ROADMAP_ERROR, "no more memory (roadmap_line_speed)");
      return NULL;
   }
 ...
 * @return
 */
int roadmap_line_speed_get_cross_time_at (int line, int against_dir, int at_time)
{
   int time_slot;
