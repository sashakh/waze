/* roadmap_gtkcanvas.h - manage the roadmap canvas using Gtk.
 *
 * LICENSE:
 *
...
#ifndef INCLUDE__ROADMAP_GTK_MAIN__H
#define INCLUDE__ROADMAP_GTK_MAIN__H

#include <gtk/gtk.h>

/* This function is called by roadmap_dialog.c, a GUI toolkit
 * dependent module.
 */
